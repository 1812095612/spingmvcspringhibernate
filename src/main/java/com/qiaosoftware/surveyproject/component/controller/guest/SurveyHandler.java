...
import com.qiaosoftware.surveyproject.exception.RemoveSurveyFailedException;
...
public class SurveyHandler {
	...
	public String toDesignUI(@PathVariable("surveyId") Integer surveyId, Map<String, Object> map) {
	...
	public void removeSurvey(@PathVariable("surveyId") Integer surveyId, HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			if(cause != null) {
				...
				//2.检查cause是否是com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException
				if(cause instanceof MySQLIntegrityConstraintViolationException) {
					
					//3.抛出自定义异常，告诉系统环境：删除调查失败了
